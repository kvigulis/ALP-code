...
Item {
    ...
    property alias gaugeTemp1: gaugeTemp1
    property var gaugeColorTemp1: gaugeColorTemp1

    property alias gaugeTemp2: gaugeTemp2
    property var gaugeColorTemp2: gaugeColorTemp2

    property alias gaugeTemp3: gaugeTemp3
    property var gaugeColorTemp3: gaugeColorTemp3

    property alias gaugeTemp4: gaugeTemp4
    property var gaugeColorTemp4: gaugeColorTemp4

    property alias gaugeTemp5: gaugeTemp5
    property var gaugeColorTemp5: gaugeColorTemp5

    property alias gaugeTemp6: gaugeTemp6
    property var gaugeColorTemp6: gaugeColorTemp6

    property alias gaugeTemp7: gaugeTemp7
    property var gaugeColorTemp7: gaugeColorTemp7

    property alias gaugeTemp8: gaugeTemp8
    property var gaugeColorTemp8: gaugeColorTemp8
            ...
            RowLayout {
                ...
                ColumnLayout {
                    ...
                    TabView {
                        ...
                        //property var t1RefreshBtn: { return getTab(0).buttonRefreshPorts }
                                ...
                                ColumnLayout {
                                    ...
                                    ComboBox {                                        
                                        ...
                                        onActivated: {
                                            ...
                                            comm.acceptPortControlBox(currentIndex);
                                        }
                                    }
                                    ...
                                    ComboBox {                                        
                                        ...
                                        onActivated: {
                                            ...
                                            comm.acceptPortSensorBox(currentIndex);
                                        }
                                    }
                        ...
                        style: TabViewStyle {
                            //frameOverlap: 1
                            tab: Rectangle {
                                color: styleData.selected ? "#dddddd" :"444444"
                    ...
                    ColumnLayout {
                        ...
                        Gauge {
                            ...
                            style: GaugeStyle {
                                        valueBar: Rectangle {
                                            implicitWidth: 50
                                            color: gaugeColorTemp1
                                        }

                                        tickmarkLabel:  Text {
                                            text: styleData.value
                                            color: styleData.value >= 1000 ? tickColorHigh : tickColor
                                            antialiasing: true
                                        }
